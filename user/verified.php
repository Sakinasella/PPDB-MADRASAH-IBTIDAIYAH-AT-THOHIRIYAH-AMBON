                ...
                <div class="col-12">
                    <div class="card shadow-sm">
                        <!-- <div class="card-body">
                            ...
                            <div class="alert alert- text-center mt-4">
                                <h4 class="font-weight-bold">Selamat!</h4>
                                <p class="mb-0">Anda Sudah Terdaftar Menjadi Siswa Baru MI At-Thohiriyah Ambon</p>
                            </div>
                        </div> -->
                    </div>
                </div>
...
<!------------------ Pisahin ------------------->
                            ...
                            <div class="row mt-5 mb-5">
                                <div class="col-12">
                                    ...
                                    <h2 class="text-dark font-weight-bold">
                                        <i class=""></i> Formulir Pendaftaran
                                    </h2>
                                </div>
                                <br><br>
                                ...
                                <div class="market-status-table mt-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="modal-footer">
                                            <a href="report.php?u=<?php echo $ambil['nik']?>" class="btn btn-dark">Unduh Formulir</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
