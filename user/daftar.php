...
<head>
    ...
    <title>PPDB : User/Pendaftaran</title>
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive" style="overflow-x:hidden;">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="scanijazahdepan" class="form-control-label">Scan Akta Kelahiran (JPG/PNG), maks 500kb</label>
                                                    <br>
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="scanijazahbelakang" class="form-control-label">Scan Kartu Keluarga (JPG/PNG), maks 500kb</label>
                                                    <br>
