                ...
                <div class="modal fade" id="myModal">
                    ...
                    <form method="post">
                        ...
                        <div class="modal-body text-center">
                            <h5 class="font-weight-bold mb-3">Konfirmasi Data</h5>
                            <p class="mb-4">Apakah Anda yakin untuk <span class="font-weight-bold">konfirmasi data Anda?</span><br>
                            Setelah dikonfirmasi, <span class="text-danger">data tidak dapat diubah kembali.</span></p>
                        <input type="hidden" value="<?=$userid;?>" name="id">
                    </div>
