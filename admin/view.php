                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                       <form id="studentForm">
                                        ...
                                        <input type="hidden" id="phoneNumber" value="6285320110524"> <!-- Hidden input with phone number -->
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive" style="overflow-x:hidden;">
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                        <label for="scanijazahdepan" class=" form-control-label">Scan Akta Kelahiran</label>
                                                        <br>
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                        <label for="scanijazahbelakang" class=" form-control-label">Scan Kartu Keluarga</label>
                                                        <br>
                                        ...
                                        <a href="unduh.php?u=<?php echo $ambil['nik']?>" class="btn btn-dark">Unduh Formulir</a>
                                        <!-- <a href="form.php" class="btn btn-primary">Kembali</a> -->
                                        <form method="post" id="studentForm">
                                            <input type="hidden" id="phoneNumber" value="6285320110524"> 

                                            
                                            <input type="hidden" name="id" value="<?php echo $userid; ?>"> <!-- Menambahkan id untuk form -->
                                            <button type="submit" name="konfirmasi" class="btn btn-success" id="confirmButton">
                                                <?php echo ($ambil['status'] == 'terdaftar') ? 'Terdaftar' : 'Konfirmasi'; ?>
                                            </button>
                                        </form>
                                    </div>   
                                </div>
...
<script>
     //Tambahkan event listener untuk tombol dengan id 'confirmButton
  document.getElementById('confirmButton').addEventListener('click', function() {
    // Tampilkan popup konfirmasi
    if (confirm('Konfirmasi siswa baru?')) {
      // Ambil nomor telepon dari formulir
      var phoneNumber = document.getElementById('phoneNumber').value;
      // Pastikan nomor telepon ada
      if (phoneNumber) {
        var message = encodeURIComponent('Selamat! Anda telah diterima sebagai siswa/siswi Madrasah Ibtidaiyah At-Thohiriyah Ambon. Informasi lebih lanjut akan disampaikan melalui grup orang tua.');
        // Arahkan ke WhatsApp dengan nomor telepon dari formulir
        window.location.href = 'https://wa.me/' + phoneNumber + '?text=' + message;
      } else {
        console.error('Nomor telepon tidak ditemukan di formulir');
      }
    }
  });
</script>
